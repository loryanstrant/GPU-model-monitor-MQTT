...
print("TOPIC: gpu_monitor/myserver/active_processes")
print("-"*80)
...
print("TOPIC: gpu_monitor/myserver/process_history")
print("-"*80)
...
print("="*80)
print()
print("Sensor: sensor.gpu_monitor_myserver_nvidia_geforce_rtx_5080_active_processes")
...
print()
print("Sensor: sensor.gpu_monitor_myserver_nvidia_geforce_rtx_5080_process_history")
...
print("  {{ state_attr('sensor.gpu_monitor_myserver_nvidia_geforce_rtx_5080_active_processes', 'processes') | map(attribute='name') | list }}")
print()
print("Get process with highest memory:")
print("  {{ state_attr('sensor.gpu_monitor_myserver_nvidia_geforce_rtx_5080_active_processes', 'processes') | sort(attribute='memory_current', reverse=true) | first }}")
print()
print("Total memory used by processes:")
print("  {{ state_attr('sensor.gpu_monitor_myserver_nvidia_geforce_rtx_5080_active_processes', 'processes') | map(attribute='memory_current') | sum }}")
print()
